...
import { Heart, Instagram, MessageCircle, Facebook, Star, QrCode, ArrowRight, Film } from "lucide-react";
      ...
      <div className="w-full max-w-md space-y-10 text-center">
        ...
        <div className="space-y-4">
          ...
          <p className="text-slate-400 text-sm font-medium leading-relaxed max-w-[280px] mx-auto">
            Thank you for dining with ART Cinemas today.
          </p>
        </div>
        ...
        >
          ...
          <p className="font-bold text-slate-800 text-sm mb-1">Loved the show?</p>
          <p className="text-xs text-slate-400 mb-6 font-medium">Rate ART Cinemas on Google</p>
        ...
        <div className="bg-orange-100/50 rounded-3xl p-6 border border-orange-200 max-w-[320px] mx-auto">
          <div className="flex items-center justify-center gap-2 text-orange-400 mb-3">
            ...
            <span className="text-[9px] font-black uppercase tracking-widest">Encore?</span>
          </div>
